...
\hypersetup{
  pdftitle={Marriage PDF},
  pdfauthor={Jason Yang},
  colorlinks=true,
  linkcolor={blue},
  filecolor={Maroon},
  citecolor={Blue},
...
\title{Marriage PDF\thanks{Code and data are available at: LINK.}}
\usepackage{etoolbox}
\makeatletter
...
\maketitle
\begin{abstract}
Stimulated data and downloaded the marriage data from the
https://open.toronto.ca/dataset/marriage-licence-statistics/ for
cleaning and data representing.
\end{abstract}
